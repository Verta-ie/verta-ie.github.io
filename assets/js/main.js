		...
		$(function() {
			...
			// Gallery.
				$('.gallery')
					...
					.prepend('<div class="modal" tabIndex="-1"><div class="inner"><iframe src="" style="padding-top:50px; min-width:90vw; min-height:90vh;"></iframe></div></div>')
						.find('iframe')
